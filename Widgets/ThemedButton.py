...
class Button_2(Button):
    ...
    def pack(self, **kwargs):
        super().pack(**kwargs)
        shutil.copy2(os.path.join("ThemeAssets", "ThemedButton", "Button_2", "baseline_arrow_forward_white_18dp_1x.png"), f"temp")
...
class Button_Icon_white(Button):
    ...
    def pack(self, **kwargs):
        ...
        self.save(lambda val: self.configure(border_width=val), "border_width", 0, 0)
        self.save(lambda val: self.configure(text_color_disabled=val), "text_color_disabled", ["gray78", "gray68"], ["gray78", "gray68"])
        shutil.copy2(os.path.join("ThemeAssets", "ThemedButton", "Icon_White", "baseline_people_white_18dp_1x.png"), f"temp")
        self.set_image(os.path.join("ThemeAssets", "ThemedButton", "Icon_White", "baseline_people_white_18dp_1x.png"), size=(18, 18))
...
class Button_Icon_black(Button):
    ...
    def pack(self, **kwargs):
        ...
        self.save(lambda val: self.configure(border_width=val), "border_width", 0, 0)
        self.save(lambda val: self.configure(text_color_disabled=val), "text_color_disabled", ["gray78", "gray68"], ["gray78", "gray68"])
        shutil.copy2(os.path.join("ThemeAssets", "ThemedButton", "Icon_Black", "baseline_people_black_18dp_1x.png"), f"temp")
        self.set_image(os.path.join("ThemeAssets", "ThemedButton", "Icon_Black", "baseline_people_black_18dp_1x.png"), size=(18, 18))
